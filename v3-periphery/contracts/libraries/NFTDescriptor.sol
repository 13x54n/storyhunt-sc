...
import '../libraries/openzeppelin/contracts/math/SignedSafeMath.sol';
...
library NFTDescriptor {
    ...
    struct ConstructTokenURWIParams {
        uint256 tokenId;
    ...
    function constructTokenURI(ConstructTokenURWIParams memory params) public pure returns (string memory) {
    ...
    function generateDescriptionPartOne(
        ...
        return
            string(
                abi.encodePacked(
                    'This NFT represents a liquidity position in a StoryHunt V3 ',
                    quoteTokenSymbol,
                    '-',
                    baseTokenSymbol,
                    ' pool. ',
    ...
    function generateName(ConstructTokenURWIParams memory params, string memory feeTier)
        private
        pure
    ...
    function generateSVGImage(ConstructTokenURWIParams memory params) internal pure returns (string memory svg) {
