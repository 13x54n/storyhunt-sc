...
import '@storyhunt/v3-core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IStoryHuntSwapCallback, PeripheryImmutableState {
    ...
    function storyhuntV3SwapCallback(
        ...
        IStoryHuntPool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IStoryHuntPool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
