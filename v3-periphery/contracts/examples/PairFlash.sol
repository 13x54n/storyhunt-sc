...
import '@storyhunt/v3-core/contracts/interfaces/callback/IStoryHuntFlashCallback.sol';
...
contract PairFlash is IStoryHuntFlashCallback, PeripheryPayments {
    ...
    function initFlash(FlashParams memory params) external {
        ...
        IStoryHuntPool pool = IStoryHuntPool(PoolAddress.computeAddress(factory, poolKey));
