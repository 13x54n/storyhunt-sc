...
describe('StoryHuntFactory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as StoryHuntFactory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('StoryHuntPool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('StoryHuntPool')
