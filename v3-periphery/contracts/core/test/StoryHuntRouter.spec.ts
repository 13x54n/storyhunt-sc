...
describe('StoryHuntPool', () => {
  ...
  let pool0: MockTimeStoryHuntPool
  let pool1: MockTimeStoryHuntPool
  ...
  let swapTargetCallee: TestStoryHuntCallee
  let swapTargetRouter: TestStoryHuntRouter
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeStoryHuntPool, any]> => {
