...
contract NFTDescriptorTest {
    ...
    function constructTokenURI(NFTDescriptor.ConstructTokenURWIParams calldata params)
        public
        pure
    ...
    function getGasCostOfConstructTokenURI(NFTDescriptor.ConstructTokenURWIParams calldata params)
        public
        view
        returns (uint256)
    {
    ...
    function generateSVGImage(NFTDescriptor.ConstructTokenURWIParams memory params) public pure returns (string memory) {
